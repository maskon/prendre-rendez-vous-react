    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={classes.block}>
        <input
          ...
          {...register("Name", { required: true, minLength: 3, pattern: /^[а-яА-ЯёЁa-zA-Z]+$/ })}
        />
      ...
      <div className={classes.block}>
        <input
          ...
          {...register("Branch", { required: true, minLength: 3, pattern: /^[а-яА-ЯёЁa-zA-Z]+$/ })}
        />
      ...
      <div className={classes.block}>
        <input
          ...
          {...register("Speciality", { required: true, minLength: 3, pattern: /^[а-яА-ЯёЁa-zA-Z]+$/ })}
        />
      ...
      <div className={classes.block}>
        <input
          ...
          {...register("Policy", { required: true, minLength: 16, pattern: /^[0-9]+[0-9]*$/ })}
        />
